...
const slide_group = document.querySelector(".slide_group")
...
function prev(){
    ...
    slide_group.style.transform = `translateX(${position}px)` /* images 스타일 transform, x축 변경*/
...
function next(){ 
    if(curPos < 3){
        ...
        /*
            ...
            - skew() : 요소 비틀기
        */
            slide_group.style.transform = `translateX(${position}px)`
        curPos += 1;  
    }
    if(curPos == 3){
        // 뒤로 못 가게 하기
